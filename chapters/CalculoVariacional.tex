...
\end{equation} \refstepcounter{subsection}
Y como la variación en los extremos de anula (1.1.4), se verifica que $\delta \tilde{F} = \delta F$, y por lo tanto (1.2.3) permanece invariante bajo esta transformación.
%-------------------------------------------------------------------------------------------
