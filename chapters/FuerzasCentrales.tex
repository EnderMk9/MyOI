...
\subsubsection{Primera Ley de \textit{Kepler}}
...
$m_2$ se encuentra en uno de los focos de la elipse por estar precisamente una distancia d del centro, esta es la primera ley de \textit{Kepler}.
...
\end{equation} \refstepcounter{subsection}
Que dado $m_2 >> m_1$, entonces $\mu = m_1$ y si $\gamma = G m_1 m_2 $, (5.7.14) se transforma en la tercera ley de \textit{Kepler}.
\begin{equation} \label{5.1.14}
